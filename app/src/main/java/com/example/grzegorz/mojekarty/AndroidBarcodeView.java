...
public class AndroidBarcodeView extends View
{
    ...
    public AndroidBarcodeView(Context context, String number) {
        super(context);
    ...
    {
        Log.e("Number", number);
        this.number = number.substring(0, number.length()-1);
...
//            testQRCode(canvas);
    ...
    private void testEAN13(Canvas canvas) throws Exception
    {
